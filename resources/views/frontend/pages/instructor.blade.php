<section class="content-view" data-panel="instructor-dashboard">
...
<section class="content-view" data-panel="instructor-courses">
    ...
    <section class="panel">
        ...
        <div class="table-wrap"><table><thead><tr><th>Course ID</th><th>Course Name</th><th>Description</th><th>Duration</th><th>Enrolled Students</th></tr></thead><tbody id="instructor-course-table"></tbody></table></div>
    </section>
</section>
